...
for (acre of fujiAcres){
    fujiTons.push(acre*6.5)
}
for (acre of galaAcres){
    galaTons.push(acre*6.5)
}
for (acre of pinkAcres){
    pinkTons.push(acre*6.5)
}
// PROBLEM 5
...
let fujiProfit = fujiSum*fujiPrice
let galaProfit = galaSum*galaPrice
let pinkProfit = pinkSum*pinkPrice
